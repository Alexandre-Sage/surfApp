...
export const CameraButtons = ({ flashActived, camera, flashStatus, setRatio }: CameraButtonsProps): JSX.Element => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity style={styles.flashButton} onPress={() => setFlash(flashStatus === 0 ? 1 : 0)}>
        <SvgUri fill={"white"} uri={imagePath} style={styles.flashSvg} />
      </TouchableOpacity>
      <TouchableOpacity style={styles.takePicturebutton} onPress={() => takePicture(camera)} />
