...
exports.default = describe("2.2) POST WITH EMPTY USER ID", function () {
    (0, mongoValidationError_test_1.default)(addMongoEntries_1.default, spotAssets_1.emptyUserId, "userId", "required", "It should return empty userId");
});
