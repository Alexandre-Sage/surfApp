...
exports.default = describe("2.2) POST WITH EMPTY WIND", function () {
    (0, mongoValidationError_test_1.default)(addMongoEntries_1.default, sessionAssets_1.missingWind, "wind.strength", "required", "It should return empty wind");
});
