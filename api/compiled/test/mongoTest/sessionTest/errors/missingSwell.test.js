...
exports.default = describe("2.4) POST WITH EMPTY SWELL", function () {
    (0, mongoValidationError_test_1.default)(addMongoEntries_1.default, sessionAssets_1.missingSwell, "swell.size", "required", "It should return empty swell");
});
