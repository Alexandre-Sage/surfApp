...
exports.default = describe("1) GET THE COOKIE FOR SIGN UP", function () {
    ...
    it("Should get a cookie", (done) => {
        ...
        (0, httpModule_test_1.testGetRoute)(agentObj, "/sign-up/csrf", globalsTestVar_1.jsonHeader200ObjCookie, globalsTestVar_1.noErrorObject, globalsTestVar_1.assertBodyNoRedirectObj)
            .then(() => done())
            .catch((err) => done(err));
    });
});
