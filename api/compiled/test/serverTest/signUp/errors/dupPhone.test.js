...
exports.default = describe("3.3) SHOULD RETURN DUPLICATE PHONE ERROR", function () {
    it("Should post a new user and return error for duplicate phone", () => __awaiter(this, void 0, void 0, function* () {
        const chai = (0, globalsTestVar_1.chaiAgent)();
        const agentObj = { agent: chai.request.agent(server_1.default) };
        const sendBody = Object.assign({}, signUpAssets_1.dupPhoneObject);
