...
exports.default = describe("3.8) SHOULD RETURN MISSING EMAIL ERROR", function () {
    it("Should post a new user and return error for missing email", () => __awaiter(this, void 0, void 0, function* () {
        const chai = (0, globalsTestVar_1.chaiAgent)();
        const agentObj = { agent: chai.request.agent(server_1.default) };
        const sendBody = Object.assign({}, signUpAssets_1.missingEmailObject);
