...
exports.default = describe("3.9) SHOULD RETURN MISSING PASSWORD ERROR", function () {
    it("Should post a new user and return error for missing password", () => __awaiter(this, void 0, void 0, function* () {
        const chai = (0, globalsTestVar_1.chaiAgent)();
        const agentObj = { agent: chai.request.agent(server_1.default) };
        const sendBody = signUpAssets_1.missingPasswordObject;
