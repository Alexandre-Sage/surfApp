...
exports.default = describe("3.10) SHOULD RETURN INVALID PASSWORD CONFIRMATION ERROR", function () {
    it("Should post a new user and return error for invalid password confirmation", () => __awaiter(this, void 0, void 0, function* () {
        const chai = (0, globalsTestVar_1.chaiAgent)();
        const agentObj = { agent: chai.request.agent(server_1.default) };
        const sendBody = signUpAssets_1.differentPasswordObject;
