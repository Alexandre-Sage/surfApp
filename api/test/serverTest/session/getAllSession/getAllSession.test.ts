...
export default describe("2) SHOULD GET ALL SESSION", function () {
    it("Should log and get user Session", async () => {
        ...
        try {
            ...
            await testGetRoute(agentObj, "/session/getAllSessions", jsonHeader200ObjectNoCookie, noErrorObject, assertBodyNoRedirectObj)
